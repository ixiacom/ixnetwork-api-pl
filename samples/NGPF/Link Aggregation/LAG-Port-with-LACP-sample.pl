...
my $lag1lacp = ($ixNet->getList($lag1eth, 'nglacp'))[0];
my $lag2lacp = ($ixNet->getList($lag2eth, 'nglacp'))[0];
...
#my $lag1slag = ($ixNet->getList($lag1eth, 'ngstaticlag'))[0];
#my $lag2slag = ($ixNet->getList($lag2eth, 'ngstaticlag'))[0];
##################################################################################
